// $ANTLR 3.5.1 S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g 2016-02-05 13:53:04
...
public class NetworkSpecParser extends Parser {
	...
	public final void device_def() throws RecognitionException {
		...
		try {
			...
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:41:6: ( 'description' ':' description_def ';' )*
			loop7:
			while (true) {
				int alt7=2;
				...
				switch (alt7) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\NetworkSpec.g:41:7: 'description' ':' description_def ';'
					{
					match(input,14,FOLLOW_14_in_device_def217); 
					match(input,11,FOLLOW_11_in_device_def219); 
					pushFollow(FOLLOW_description_def_in_device_def221);
					description_def();
					state._fsp--;

					match(input,12,FOLLOW_12_in_device_def223); 
					}
					break;
	...
	public static final BitSet FOLLOW_12_in_device_def185 = new BitSet(new long[]{0x0000000000006002L});
	...
	public static final BitSet FOLLOW_12_in_device_def199 = new BitSet(new long[]{0x0000000000006002L});
	public static final BitSet FOLLOW_14_in_device_def217 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_device_def219 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_description_def_in_device_def221 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_device_def223 = new BitSet(new long[]{0x0000000000004002L});
