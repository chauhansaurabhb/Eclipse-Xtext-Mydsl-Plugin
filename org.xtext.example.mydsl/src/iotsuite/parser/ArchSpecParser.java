// $ANTLR 3.5.1 S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g 2016-02-05 13:53:08
...
public class ArchSpecParser extends Parser {
	public static final String[] tokenNames = new String[] {
		...
		"WS", "'('", "')'", "','", "':'", "';'", "'Boolean'", "'COMPUTE'", "'Common'", 
		"'Custom'", "'Integer'", "'String'", "'_BY_SAMPLE'", "'boolean'", "'command'", 
	...
	public final void archSpec() throws RecognitionException {
		try {
			...
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:28:5: ( 'softwareComponents' ':' )*
			loop2:
			while (true) {
				int alt2=2;
				...
				switch (alt2) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:28:6: 'softwareComponents' ':'
					{
			...
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:28:33: ( component_def )*
			loop3:
			while (true) {
				int alt3=2;
				...
				switch (alt3) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:28:34: component_def
					{
	...
	public final void struct_def() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID1=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_struct_def158); 
	...
	// $ANTLR start "cs_def"
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:47:1: cs_def : ( 'Common' ':' )* ( agg_cs_def )* ( 'Custom' ':' ) ( controller_def )+ ;
	public final void cs_def() throws RecognitionException {
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:47:7: ( ( 'Common' ':' )* ( agg_cs_def )* ( 'Custom' ':' ) ( controller_def )+ )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:49:3: ( 'Common' ':' )* ( agg_cs_def )* ( 'Custom' ':' ) ( controller_def )+
			{
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:49:3: ( 'Common' ':' )*
			loop5:
			while (true) {
				int alt5=2;
				...
				switch (alt5) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:49:4: 'Common' ':'
					{
	...
	public final void agg_cs_def() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID4=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_agg_cs_def325); 
	...
	public final void controller_def() throws RecognitionException {
		...
		try {
			...
			{
			CAPITALIZED_ID5=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_controller_def413); 
	...
	public final void csOperation_def() throws RecognitionException {
		...
		try {
			...
			CAPITALIZED_ID6=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csOperation_def505); 
			match(input,19,FOLLOW_19_in_csOperation_def506); 
			match(input,10,FOLLOW_10_in_csOperation_def509); 
			INT7=(Token)match(input,INT,FOLLOW_INT_in_csOperation_def511); 
	...
	public final void csGeneratedInfoForAggregator_def() throws RecognitionException {
		...
		try {
			...
			{
			match(input,26,FOLLOW_26_in_csGeneratedInfoForAggregator_def537); 
			...
			CAPITALIZED_ID9=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csGeneratedInfoForAggregator_def544); 
			    ...
			    context.constructAggregatorSymblTable((CAPITALIZED_ID9!=null?CAPITALIZED_ID9.getText():null));
			     context.constructGUISymblTable((lc_id8!=null?input.toString(lc_id8.start,lc_id8.stop):null), (CAPITALIZED_ID9!=null?CAPITALIZED_ID9.getText():null));   
			      context.constructConsumeInfoSymblTable((lc_id8!=null?input.toString(lc_id8.start,lc_id8.stop):null), (CAPITALIZED_ID9!=null?CAPITALIZED_ID9.getText():null));
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:140:1: csGeneratedInfo_def : 'generate' lc_id ':' CAPITALIZED_ID ;
	public final void csGeneratedInfo_def() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:140:20: ( 'generate' lc_id ':' CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:141:5: 'generate' lc_id ':' CAPITALIZED_ID
			{
			...
			CAPITALIZED_ID11=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csGeneratedInfo_def570); 
			 context.currentComputationalService.addGeneratedInfo((lc_id10!=null?input.toString(lc_id10.start,lc_id10.stop):null), (CAPITALIZED_ID11!=null?CAPITALIZED_ID11.getText():null)); 
			    ...
			    context.constructGUISymblTable((lc_id10!=null?input.toString(lc_id10.start,lc_id10.stop):null), (CAPITALIZED_ID11!=null?CAPITALIZED_ID11.getText():null));
			     context.constructConsumeInfoSymblTable((lc_id10!=null?input.toString(lc_id10.start,lc_id10.stop):null), (CAPITALIZED_ID11!=null?CAPITALIZED_ID11.getText():null)); 
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:150:1: csConsumeInfo_def : 'consume' lc_id 'from' CAPITALIZED_ID ;
	public final void csConsumeInfo_def() throws RecognitionException {
		ParserRuleReturnScope lc_id12 =null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:150:18: ( 'consume' lc_id 'from' CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:152:5: 'consume' lc_id 'from' CAPITALIZED_ID
			{
			...
			match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csConsumeInfo_def606); 
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:157:1: csRequest_def : 'request' lc_id 'to' CAPITALIZED_ID ;
	public final void csRequest_def() throws RecognitionException {
		ParserRuleReturnScope lc_id13 =null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:157:15: ( 'request' lc_id 'to' CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:158:4: 'request' lc_id 'to' CAPITALIZED_ID
			{
			...
			match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_csRequest_def643); 
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:163:1: cntrlCommand_def : 'command' name= CAPITALIZED_ID '(' ( cntrlParameter_def )? ')' 'to' CAPITALIZED_ID ;
	public final void cntrlCommand_def() throws RecognitionException {
		Token name=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:163:18: ( 'command' name= CAPITALIZED_ID '(' ( cntrlParameter_def )? ')' 'to' CAPITALIZED_ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:165:6: 'command' name= CAPITALIZED_ID '(' ( cntrlParameter_def )? ')' 'to' CAPITALIZED_ID
			{
			match(input,21,FOLLOW_21_in_cntrlCommand_def670); 
			name=(Token)match(input,CAPITALIZED_ID,FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def677); 
			match(input,8,FOLLOW_8_in_cntrlCommand_def679); 
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:165:43: ( cntrlParameter_def )?
			int alt15=2;
			...
			switch (alt15) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:165:44: cntrlParameter_def
					{
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:171:1: cntrlParameter_def : lc_id ;
	public final void cntrlParameter_def() throws RecognitionException {
		ParserRuleReturnScope lc_id14 =null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:171:20: ( lc_id )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:172:5: lc_id
			{
	...
	// $ANTLR start "lc_id"
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:185:1: lc_id : ID ;
	public final ArchSpecParser.lc_id_return lc_id() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:185:6: ( ID )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:185:8: ID
			{
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:188:1: dataType : primitiveType ;
	public final ArchSpecParser.dataType_return dataType() throws RecognitionException {
		...
		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:188:9: ( primitiveType )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:189:3: primitiveType
			{
	...
	// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:192:1: primitiveType : (id= 'Integer' |id= 'Boolean' |id= 'String' |id= 'double' |id= 'long' |id= 'boolean' ) ;
	public final void primitiveType() throws RecognitionException {
		Token id=null;

		try {
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:192:14: ( (id= 'Integer' |id= 'Boolean' |id= 'String' |id= 'double' |id= 'long' |id= 'boolean' ) )
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:193:3: (id= 'Integer' |id= 'Boolean' |id= 'String' |id= 'double' |id= 'long' |id= 'boolean' )
			{
			// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:193:3: (id= 'Integer' |id= 'Boolean' |id= 'String' |id= 'double' |id= 'long' |id= 'boolean' )
			int alt16=6;
			switch ( input.LA(1) ) {
			...
			switch (alt16) {
				case 1 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:193:4: id= 'Integer'
					{
					id=(Token)match(input,17,FOLLOW_17_in_primitiveType772); 
					}
					break;
				case 2 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:193:19: id= 'Boolean'
					{
					id=(Token)match(input,13,FOLLOW_13_in_primitiveType778); 
					}
					break;
				case 3 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:193:34: id= 'String'
					{
					id=(Token)match(input,18,FOLLOW_18_in_primitiveType784); 
					}
					break;
				case 4 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:193:49: id= 'double'
					{
					id=(Token)match(input,24,FOLLOW_24_in_primitiveType793); 
					}
					break;
				case 5 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:193:65: id= 'long'
					{
					id=(Token)match(input,27,FOLLOW_27_in_primitiveType801); 
					}
					break;
				case 6 :
					// S:\\Thesis\\DevelopmentFramework\\ToolSuite\\IoTSuite\\src\\iotsuite\\parser\\ArchSpec.g:193:79: id= 'boolean'
					{
	...
	public static final BitSet FOLLOW_struct_def_in_archSpec92 = new BitSet(new long[]{0x0000000060400002L});
	public static final BitSet FOLLOW_29_in_archSpec103 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_archSpec105 = new BitSet(new long[]{0x0000000020400002L});
	public static final BitSet FOLLOW_component_def_in_archSpec110 = new BitSet(new long[]{0x0000000000400002L});
	public static final BitSet FOLLOW_22_in_component_def133 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_component_def135 = new BitSet(new long[]{0x0000000000018010L});
	public static final BitSet FOLLOW_cs_def_in_component_def138 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_struct_def158 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_structField_def_in_struct_def172 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_struct_def174 = new BitSet(new long[]{0x0000000000000022L});
	public static final BitSet FOLLOW_lc_id_in_structField_def198 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_structField_def200 = new BitSet(new long[]{0x0000000009162000L});
	public static final BitSet FOLLOW_dataType_in_structField_def202 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_15_in_cs_def229 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_cs_def231 = new BitSet(new long[]{0x0000000000018010L});
	public static final BitSet FOLLOW_agg_cs_def_in_cs_def251 = new BitSet(new long[]{0x0000000000010010L});
	public static final BitSet FOLLOW_16_in_cs_def259 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_cs_def261 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_controller_def_in_cs_def278 = new BitSet(new long[]{0x0000000000000012L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_agg_cs_def325 = new BitSet(new long[]{0x0000000004804002L});
	public static final BitSet FOLLOW_csConsumeInfo_def_in_agg_cs_def339 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_agg_cs_def341 = new BitSet(new long[]{0x0000000004804002L});
	public static final BitSet FOLLOW_csOperation_def_in_agg_cs_def351 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_agg_cs_def353 = new BitSet(new long[]{0x0000000004004002L});
	public static final BitSet FOLLOW_csGeneratedInfoForAggregator_def_in_agg_cs_def362 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_agg_cs_def364 = new BitSet(new long[]{0x0000000004000002L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_controller_def413 = new BitSet(new long[]{0x0000000014A00002L});
	public static final BitSet FOLLOW_csConsumeInfo_def_in_controller_def427 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_controller_def429 = new BitSet(new long[]{0x0000000014A00002L});
	public static final BitSet FOLLOW_csRequest_def_in_controller_def441 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_controller_def443 = new BitSet(new long[]{0x0000000014200002L});
	public static final BitSet FOLLOW_csGeneratedInfo_def_in_controller_def454 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_controller_def456 = new BitSet(new long[]{0x0000000004200002L});
	public static final BitSet FOLLOW_cntrlCommand_def_in_controller_def468 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_12_in_controller_def470 = new BitSet(new long[]{0x0000000000200002L});
	public static final BitSet FOLLOW_14_in_csOperation_def501 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_csOperation_def503 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csOperation_def505 = new BitSet(new long[]{0x0000000000080000L});
	public static final BitSet FOLLOW_19_in_csOperation_def506 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_csOperation_def509 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_INT_in_csOperation_def511 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_csOperation_def513 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_26_in_csGeneratedInfoForAggregator_def537 = new BitSet(new long[]{0x0000000000000020L});
	...
	public static final BitSet FOLLOW_26_in_csGeneratedInfo_def563 = new BitSet(new long[]{0x0000000000000020L});
	...
	public static final BitSet FOLLOW_23_in_csConsumeInfo_def598 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_csConsumeInfo_def600 = new BitSet(new long[]{0x0000000002000000L});
	public static final BitSet FOLLOW_25_in_csConsumeInfo_def603 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csConsumeInfo_def606 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_28_in_csRequest_def637 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_lc_id_in_csRequest_def639 = new BitSet(new long[]{0x0000000080000000L});
	public static final BitSet FOLLOW_31_in_csRequest_def641 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_csRequest_def643 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_21_in_cntrlCommand_def670 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_CAPITALIZED_ID_in_cntrlCommand_def677 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_cntrlCommand_def679 = new BitSet(new long[]{0x0000000000000220L});
	public static final BitSet FOLLOW_cntrlParameter_def_in_cntrlCommand_def682 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_cntrlCommand_def686 = new BitSet(new long[]{0x0000000080000000L});
	public static final BitSet FOLLOW_31_in_cntrlCommand_def688 = new BitSet(new long[]{0x0000000000000010L});
	...
	public static final BitSet FOLLOW_17_in_primitiveType772 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_13_in_primitiveType778 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_18_in_primitiveType784 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_24_in_primitiveType793 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_27_in_primitiveType801 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_20_in_primitiveType807 = new BitSet(new long[]{0x0000000000000002L});
}
