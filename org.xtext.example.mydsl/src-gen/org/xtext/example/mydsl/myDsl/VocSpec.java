 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.VocSpec#getRequestSensors <em>Request Sensors</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.VocSpec#getTags <em>Tags</em>}</li>
...
public interface VocSpec extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Request Sensors</b></em>' containment reference list.
   * The list contents are of type {@link org.xtext.example.mydsl.myDsl.RequestSensors}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Request Sensors</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Request Sensors</em>' containment reference list.
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getVocSpec_RequestSensors()
   * @model containment="true"
   * @generated
   */
  EList<RequestSensors> getRequestSensors();

  /**
   * Returns the value of the '<em><b>Tags</b></em>' containment reference list.
   * The list contents are of type {@link org.xtext.example.mydsl.myDsl.Tags}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getVocSpec_Tags()
   * @model containment="true"
   * @generated
   */
  EList<Tags> getTags();
