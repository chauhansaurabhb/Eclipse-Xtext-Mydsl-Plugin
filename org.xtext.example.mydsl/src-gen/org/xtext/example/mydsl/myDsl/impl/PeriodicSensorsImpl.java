 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.PeriodicSensorsImpl#getSampelingDef <em>Sampeling Def</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PeriodicSensorsImpl extends MinimalEObjectImpl.Container implements PeriodicSensors
{
  ...
  /**
   * The default value of the '{@link #getSampelingDef() <em>Sampeling Def</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getSampelingDef()
   * @generated
   * @ordered
   */
  protected static final String SAMPELING_DEF_EDEFAULT = null;

  /**
   * The cached value of the '{@link #getSampelingDef() <em>Sampeling Def</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getSampelingDef()
   * @generated
   * @ordered
   */
  protected String sampelingDef = SAMPELING_DEF_EDEFAULT;
   ...
   * @generated
   */
  public void setSampelingDef(String newSampelingDef)
  {
    String oldSampelingDef = sampelingDef;
    sampelingDef = newSampelingDef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.PERIODIC_SENSORS__SAMPELING_DEF, oldSampelingDef, sampelingDef));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.PERIODIC_SENSORS__SAMPELING_DEF:
        return getSampelingDef();
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.PERIODIC_SENSORS__GENERATE_INFO:
        ...
        return;
      case MyDslPackage.PERIODIC_SENSORS__SAMPELING_DEF:
        setSampelingDef((String)newValue);
        return;
    }
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.PERIODIC_SENSORS__GENERATE_INFO:
        ...
        return;
      case MyDslPackage.PERIODIC_SENSORS__SAMPELING_DEF:
        setSampelingDef(SAMPELING_DEF_EDEFAULT);
        return;
    }
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.PERIODIC_SENSORS__SAMPELING_DEF:
        return SAMPELING_DEF_EDEFAULT == null ? sampelingDef != null : !SAMPELING_DEF_EDEFAULT.equals(sampelingDef);
    }
