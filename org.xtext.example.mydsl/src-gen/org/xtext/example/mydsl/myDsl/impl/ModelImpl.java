 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ModelImpl#getVocSpec <em>Voc Spec</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ModelImpl#getInteractionSpec <em>Interaction Spec</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ModelImpl#getArchSpec <em>Arch Spec</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ModelImpl#getNetworkSpec <em>Network Spec</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  public NotificationChain basicSetVocSpec(VocSpec newVocSpec, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.MODEL__VOC_SPEC, oldVocSpec, newVocSpec);
  ...
  public void setVocSpec(VocSpec newVocSpec)
  {
    if (newVocSpec != vocSpec)
    {
      ...
      if (vocSpec != null)
        msgs = ((InternalEObject)vocSpec).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MODEL__VOC_SPEC, null, msgs);
      if (newVocSpec != null)
        msgs = ((InternalEObject)newVocSpec).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MODEL__VOC_SPEC, null, msgs);
      msgs = basicSetVocSpec(newVocSpec, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.MODEL__VOC_SPEC, newVocSpec, newVocSpec));
  }
  ...
  public NotificationChain basicSetInteractionSpec(InteractionSpec newInteractionSpec, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.MODEL__INTERACTION_SPEC, oldInteractionSpec, newInteractionSpec);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setInteractionSpec(InteractionSpec newInteractionSpec)
  {
    if (newInteractionSpec != interactionSpec)
    {
      ...
      if (interactionSpec != null)
        msgs = ((InternalEObject)interactionSpec).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MODEL__INTERACTION_SPEC, null, msgs);
      if (newInteractionSpec != null)
        msgs = ((InternalEObject)newInteractionSpec).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MODEL__INTERACTION_SPEC, null, msgs);
      msgs = basicSetInteractionSpec(newInteractionSpec, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.MODEL__INTERACTION_SPEC, newInteractionSpec, newInteractionSpec));
  }
  ...
  public NotificationChain basicSetArchSpec(ArchSpec newArchSpec, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.MODEL__ARCH_SPEC, oldArchSpec, newArchSpec);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setArchSpec(ArchSpec newArchSpec)
  {
    if (newArchSpec != archSpec)
    {
      NotificationChain msgs = null;
      if (archSpec != null)
        msgs = ((InternalEObject)archSpec).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MODEL__ARCH_SPEC, null, msgs);
      if (newArchSpec != null)
        msgs = ((InternalEObject)newArchSpec).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MODEL__ARCH_SPEC, null, msgs);
      msgs = basicSetArchSpec(newArchSpec, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.MODEL__ARCH_SPEC, newArchSpec, newArchSpec));
  }
  ...
  public NotificationChain basicSetNetworkSpec(DeploymentSpec newNetworkSpec, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.MODEL__NETWORK_SPEC, oldNetworkSpec, newNetworkSpec);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setNetworkSpec(DeploymentSpec newNetworkSpec)
  {
    if (newNetworkSpec != networkSpec)
    {
      NotificationChain msgs = null;
      if (networkSpec != null)
        msgs = ((InternalEObject)networkSpec).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MODEL__NETWORK_SPEC, null, msgs);
      if (newNetworkSpec != null)
        msgs = ((InternalEObject)newNetworkSpec).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MODEL__NETWORK_SPEC, null, msgs);
      msgs = basicSetNetworkSpec(newNetworkSpec, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.MODEL__NETWORK_SPEC, newNetworkSpec, newNetworkSpec));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.MODEL__VOC_SPEC:
        return basicSetVocSpec(null, msgs);
      case MyDslPackage.MODEL__INTERACTION_SPEC:
        return basicSetInteractionSpec(null, msgs);
      case MyDslPackage.MODEL__ARCH_SPEC:
        return basicSetArchSpec(null, msgs);
      case MyDslPackage.MODEL__NETWORK_SPEC:
