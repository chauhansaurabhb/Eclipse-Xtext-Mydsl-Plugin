...
public class DeviceImpl extends MinimalEObjectImpl.Container implements Device
{
   ...
   * @ordered
   */
  protected DeviceEntityName deviceName;
   ...
   * @generated
   */
  public DeviceEntityName getDeviceName()
  {
    return deviceName;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetDeviceName(DeviceEntityName newDeviceName, NotificationChain msgs)
  {
    DeviceEntityName oldDeviceName = deviceName;
    deviceName = newDeviceName;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.DEVICE__DEVICE_NAME, oldDeviceName, newDeviceName);
   ...
   * @generated
   */
  public void setDeviceName(DeviceEntityName newDeviceName)
  {
    if (newDeviceName != deviceName)
    {
      NotificationChain msgs = null;
      if (deviceName != null)
        msgs = ((InternalEObject)deviceName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.DEVICE__DEVICE_NAME, null, msgs);
      if (newDeviceName != null)
        msgs = ((InternalEObject)newDeviceName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.DEVICE__DEVICE_NAME, null, msgs);
      msgs = basicSetDeviceName(newDeviceName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.DEVICE__DEVICE_NAME, newDeviceName, newDeviceName));
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    ...
    {
      case MyDslPackage.DEVICE__DEVICE_NAME:
        setDeviceName((DeviceEntityName)newValue);
        return;
      case MyDslPackage.DEVICE__DEVICE_LOCATION:
  ...
  public void eUnset(int featureID)
  {
    ...
    {
      case MyDslPackage.DEVICE__DEVICE_NAME:
        setDeviceName((DeviceEntityName)null);
        return;
      case MyDslPackage.DEVICE__DEVICE_LOCATION:
        getDeviceLocation().clear();
        return;
