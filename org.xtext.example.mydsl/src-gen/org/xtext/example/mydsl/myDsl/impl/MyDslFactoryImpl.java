...
public class MyDslFactoryImpl extends EFactoryImpl implements MyDslFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case MyDslPackage.INTERACTION_NAME: return createInteractionName();
      ...
      case MyDslPackage.COMPUTE_INFO_FOR_IN_BUILT: return createComputeInfoForInBuilt();
      ...
      case MyDslPackage.ON_CONDITION_DEF: return createOnConditionDef();
      case MyDslPackage.REQUEST_SENSORS: return createRequestSensors();
      case MyDslPackage.TAGS: return createTags();
      case MyDslPackage.EVENT_CONDITIONS: return createEventConditions();
      case MyDslPackage.OPERATOR: return createOPERATOR();
      case MyDslPackage.DEVICE_ENTITY_NAME: return createDeviceEntityName();
      case MyDslPackage.STRUCT_ENTITY_NAME: return createStructEntityName();
      ...
      case MyDslPackage.DATA_ACCESS_FOR_REQUEST_SENSORS: return createDataAccessForRequestSensors();
   ...
   * @generated
   */
  public InteractionName createInteractionName()
  {
    InteractionNameImpl interactionName = new InteractionNameImpl();
   ...
   * @generated
   */
  public ComputeInfoForInBuilt createComputeInfoForInBuilt()
  {
    ComputeInfoForInBuiltImpl computeInfoForInBuilt = new ComputeInfoForInBuiltImpl();
    return computeInfoForInBuilt;
  }
   ...
   * @generated
   */
  public OnConditionDef createOnConditionDef()
  {
    OnConditionDefImpl onConditionDef = new OnConditionDefImpl();
   ...
   * @generated
   */
  public RequestSensors createRequestSensors()
  {
    RequestSensorsImpl requestSensors = new RequestSensorsImpl();
   ...
   * @generated
   */
  public DeviceEntityName createDeviceEntityName()
  {
    DeviceEntityNameImpl deviceEntityName = new DeviceEntityNameImpl();
   ...
   * @generated
   */
  public StructEntityName createStructEntityName()
  {
    StructEntityNameImpl structEntityName = new StructEntityNameImpl();
   ...
   * @generated
   */
  public DataAccessForRequestSensors createDataAccessForRequestSensors()
  {
    DataAccessForRequestSensorsImpl dataAccessForRequestSensors = new DataAccessForRequestSensorsImpl();
    return dataAccessForRequestSensors;
  }
