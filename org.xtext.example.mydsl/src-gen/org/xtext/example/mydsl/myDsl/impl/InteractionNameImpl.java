...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Interaction Name</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.InteractionNameImpl#getInteractionName <em>Interaction Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.InteractionNameImpl#getInteractionCommand <em>Interaction Command</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.InteractionNameImpl#getInteractionRequest <em>Interaction Request</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.InteractionNameImpl#getInteractionNotify <em>Interaction Notify</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InteractionNameImpl extends MinimalEObjectImpl.Container implements InteractionName
{
  /**
  ...
  {
    return MyDslPackage.Literals.INTERACTION_NAME;
  }
  ...
  public NotificationChain basicSetInteractionName(EntityName newInteractionName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.INTERACTION_NAME__INTERACTION_NAME, oldInteractionName, newInteractionName);
  ...
  public void setInteractionName(EntityName newInteractionName)
  {
    if (newInteractionName != interactionName)
    {
      ...
      if (interactionName != null)
        msgs = ((InternalEObject)interactionName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INTERACTION_NAME__INTERACTION_NAME, null, msgs);
      if (newInteractionName != null)
        msgs = ((InternalEObject)newInteractionName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INTERACTION_NAME__INTERACTION_NAME, null, msgs);
      msgs = basicSetInteractionName(newInteractionName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INTERACTION_NAME__INTERACTION_NAME, newInteractionName, newInteractionName));
  }
  ...
  public EList<Command> getInteractionCommand()
  {
    ...
    {
      interactionCommand = new EObjectContainmentEList<Command>(Command.class, this, MyDslPackage.INTERACTION_NAME__INTERACTION_COMMAND);
    }
  ...
  public EList<Request> getInteractionRequest()
  {
    ...
    {
      interactionRequest = new EObjectContainmentEList<Request>(Request.class, this, MyDslPackage.INTERACTION_NAME__INTERACTION_REQUEST);
    }
  ...
  public EList<InteractionAction> getInteractionNotify()
  {
    ...
    {
      interactionNotify = new EObjectContainmentEList<InteractionAction>(InteractionAction.class, this, MyDslPackage.INTERACTION_NAME__INTERACTION_NOTIFY);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.INTERACTION_NAME__INTERACTION_NAME:
        return basicSetInteractionName(null, msgs);
      case MyDslPackage.INTERACTION_NAME__INTERACTION_COMMAND:
        return ((InternalEList<?>)getInteractionCommand()).basicRemove(otherEnd, msgs);
      case MyDslPackage.INTERACTION_NAME__INTERACTION_REQUEST:
        return ((InternalEList<?>)getInteractionRequest()).basicRemove(otherEnd, msgs);
      case MyDslPackage.INTERACTION_NAME__INTERACTION_NOTIFY:
