 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.TagsImpl#getSensorName <em>Sensor Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.TagsImpl#getGenerateInfo <em>Generate Info</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TagsImpl extends MinimalEObjectImpl.Container implements Tags
{
  ...
  {
    return MyDslPackage.Literals.TAGS;
  }
  ...
  public NotificationChain basicSetSensorName(EntityName newSensorName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.TAGS__SENSOR_NAME, oldSensorName, newSensorName);
  ...
  public void setSensorName(EntityName newSensorName)
  {
    if (newSensorName != sensorName)
    {
      ...
      if (sensorName != null)
        msgs = ((InternalEObject)sensorName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.TAGS__SENSOR_NAME, null, msgs);
      if (newSensorName != null)
        msgs = ((InternalEObject)newSensorName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.TAGS__SENSOR_NAME, null, msgs);
      msgs = basicSetSensorName(newSensorName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.TAGS__SENSOR_NAME, newSensorName, newSensorName));
  }
  ...
  public EList<Generate> getGenerateInfo()
  {
    ...
    {
      generateInfo = new EObjectContainmentEList<Generate>(Generate.class, this, MyDslPackage.TAGS__GENERATE_INFO);
    }
    return generateInfo;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.TAGS__SENSOR_NAME:
        return basicSetSensorName(null, msgs);
      case MyDslPackage.TAGS__GENERATE_INFO:
