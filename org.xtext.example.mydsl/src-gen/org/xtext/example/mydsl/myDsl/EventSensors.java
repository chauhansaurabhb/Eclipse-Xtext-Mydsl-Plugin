 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.EventSensors#getOnConditionDef <em>On Condition Def</em>}</li>
 * </ul>
 *
...
public interface EventSensors extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>On Condition Def</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>On Condition Def</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>On Condition Def</em>' containment reference.
   * @see #setOnConditionDef(OnConditionDef)
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getEventSensors_OnConditionDef()
   * @model containment="true"
   * @generated
   */
  OnConditionDef getOnConditionDef();

  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.EventSensors#getOnConditionDef <em>On Condition Def</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>On Condition Def</em>' containment reference.
   * @see #getOnConditionDef()
   * @generated
   */
  void setOnConditionDef(OnConditionDef value);
