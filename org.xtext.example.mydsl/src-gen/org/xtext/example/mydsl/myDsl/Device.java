...
public interface Device extends EObject
{
   ...
   * @see #setDeviceName(DeviceEntityName)
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getDevice_DeviceName()
   * @model containment="true"
   * @generated
   */
  DeviceEntityName getDeviceName();

  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.Device#getDeviceName <em>Device Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setDeviceName(DeviceEntityName value);
