 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.Tags#getSensorName <em>Sensor Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.Tags#getGenerateInfo <em>Generate Info</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getTags()
 * @model
 * @generated
 */
public interface Tags extends EObject
{
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getTags_SensorName()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.Tags#getSensorName <em>Sensor Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getTags_GenerateInfo()
   * @model containment="true"
   * @generated
   */
